...
links:
  ...
  - "[[lecture-20032025131726|Lecture 20032025131726]]"
---
...
Di conseguenza, le iterazioni dell'algoritmo saranno al piu' $\bar{g}$. Il costo computazionale di ogni iterazione e' dominato dalla ricerca di un cammino minimo, eseguibile in tempo $O(NA)$. Di conseguenza, l'algoritmo sara' di [[complessita-computazionale|complessita']]
$$O(\bar{g}NA)$$
