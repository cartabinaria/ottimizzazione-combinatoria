...
---
## Introduzione
> Il **problema di accoppiamento di massima cardinalita'** consiste nel [[problema-di-accoppiamento|problema di accoppiamento]] di cui si vuole _massimizzare la [[cardinalita|cardinalita']] di $M$ mantenendo il vincolo degli archi sul fatto che non devono avere nodi in comune_.
...
La [[complessita-computazionale|complessita' computazionale]] di $FF$ sarebbe $O(mnU)$ dove
