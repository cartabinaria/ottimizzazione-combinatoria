...
---
## Introduzione
> L'**algoritmo di Edmonds-Karp** (o **EK**) è una versione dell'[[algoritmo-di-ford-fulkerson|algoritmo di Ford-Fulkerson]] che utilizza la visita [[bfs|BFS]] sul [[grafo-residuo|grafo residuo]] $G_{x}$ per trovare i [[cammino-aumentante|cammini aumentanti]].

Con questa piccola modifica, si ottiene che **i cammini aumentanti trovati saranno sempre di lunghezza minima**, il che _rende la [[complessita-computazionale|complessità]] dell'algoritmo polinomiale_!
